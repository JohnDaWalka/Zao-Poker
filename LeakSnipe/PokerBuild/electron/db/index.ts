...
export function initDatabase() {
    try {
        ...
        try { sqlite.exec(`ALTER TABLE hands ADD COLUMN hero_name TEXT`); } catch (_) { /* already exists */ }
        try { sqlite.exec(`ALTER TABLE hands ADD COLUMN hero_position TEXT`); } catch (_) { /* already exists */ }
